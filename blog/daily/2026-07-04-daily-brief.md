...
title: "AI Coding Daily Brief | 2026-07-04 | Copilot、Agent与VS Code的最新工程信号"
description: "2026-07-04 AI coding 日报：GitHub Changelog 的 Copilot agent session streaming is now in public preview；GitHub Changelog 的 Upcoming deprecation of Gemini 2.5 Pro and Gemini 3 Flash；GitHub Changelog 的 Enterprises can default to auto model selection。"
tags: [ai-coding, daily-brief, agent, copilot, workflow, vscode]
draft: false
---

这篇 Daily Brief 覆盖 2026-07-02 到 2026-07-04 的官方观察窗口，只保留会改变工程实践的 AI coding 信号。
...
- 2026-07-02，VS Code 发布《Visual Studio Code 1.128 (Insiders)》，这类入口层变化值得用真实仓库任务验证，而不是只看发布标题。
...
- 工程影响：这说明 Agent 能力继续从单轮对话转向可委派、可持续执行的工作流组件。
### 3. 2026-07-02，GitHub Changelog：Enterprises can default to auto model selection
...
### 4. 2026-07-02，VS Code：Visual Studio Code 1.127

- 事实：VS Code 在 2026-07-02 发布了这条更新。
- 官方摘要：Learn what is new in Visual Studio Code 1.127 
- 工程影响：这类入口层变化值得用真实仓库任务验证，而不是只看发布标题。
### 5. 2026-07-02，VS Code：Visual Studio Code 1.128 (Insiders)

- 事实：VS Code 在 2026-07-02 发布了这条更新。
- 官方摘要：Learn what's new in Visual Studio Code 1.128 (Insiders) 
- 工程影响：这类入口层变化值得用真实仓库任务验证，而不是只看发布标题。
### 6. 2026-07-03，GitHub Changelog：Improved accuracy and coverage in Copilot usage metrics reports
...
- [VS Code, 2026-07-02: Visual Studio Code 1.128 (Insiders)](https://code.visualstudio.com/updates/v1_128)
