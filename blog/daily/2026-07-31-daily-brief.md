---
slug: daily-brief-2026-07-31
title: "AI Coding Daily Brief | 2026-07-31 | Agent、工作流与Copilot的最新工程信号"
description: "2026-07-31 AI coding 日报：GitHub Changelog 的 GitHub Models is now retired；GitHub Changelog 的 Reference same-repository actions with self-repository syntax；GitHub Changelog 的 Copilot code review: Agent skills and MCP now generally available。"
tags: [ai-coding, daily-brief, workflow, agent, copilot, mcp]
draft: false
---

这篇 Daily Brief 覆盖 2026-07-29 到 2026-07-31 的官方观察窗口，只保留会改变工程实践的 AI coding 信号。
...
### 1. 2026-07-31，GitHub Changelog：GitHub Models is now retired
...
### 2. 2026-07-31，GitHub Changelog：Reference same-repository actions with self-repository syntax
...
### 3. 2026-07-30，GitHub Changelog：Copilot code review: Agent skills and MCP now generally available
...
### 4. 2026-07-30，GitHub Changelog：GitHub Copilot in Visual Studio Code, July 2026 releases
...
### 5. 2026-07-29，OpenAI News：How GPT-5.6 fuses frontier intelligence with frontier efficiency
