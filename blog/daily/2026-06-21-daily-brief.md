---
slug: daily-brief-2026-06-21
title: "AI Coding Daily Brief | 2026-06-21 | Copilot、Agent与工作流的最新工程信号"
description: "2026-06-21 AI coding 日报：GitHub Changelog 的 Upcoming deprecation of Opus 4.6 (fast)；GitHub Changelog 的 Copilot code review: AGENTS.md support and UI improvements；GitHub Changelog 的 Copilot-authored pull requests now included in author searches。"
tags: [ai-coding, daily-brief, agent, copilot, workflow, mcp]
draft: false
---

这篇 Daily Brief 覆盖 2026-06-19 到 2026-06-21 的官方观察窗口，只保留会改变工程实践的 AI coding 信号。
...
### 6. 2026-06-20，GitHub Changelog：AI credits consumed per user now in the Copilot usage metrics API
