...
const sidebars = {
  ...
  toolTutorialsSidebar: [
    'tools/index',
    {
      ...
      items: [
        'tools/terminal-agents/claude-code/quick-start',
        'tools/execution-stacks/openai-codex/quick-start',
        'tools/ide-first/cursor/quick-start',
        'tools/platforms/github-copilot/quick-start',
        'tools/control-planes/vscode-agents/quick-start',
        'tools/terminal-agents/gemini-cli/quick-start',
        'tools/terminal-agents/cline/quick-start',
        'tools/ide-first/windsurf/quick-start',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        {
          type: 'autogenerated',
          dirName: 'tools/terminal-agents/claude-code',
        },
        {
          type: 'autogenerated',
          dirName: 'tools/execution-stacks/openai-codex',
        },
        {
          type: 'autogenerated',
          dirName: 'tools/ide-first/cursor',
        },
        {
          type: 'autogenerated',
          dirName: 'tools/platforms/github-copilot',
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'autogenerated',
          dirName: 'tools/control-planes/vscode-agents',
        },
        {
          type: 'autogenerated',
          dirName: 'tools/terminal-agents/gemini-cli',
        },
        {
          type: 'autogenerated',
          dirName: 'tools/terminal-agents/cline',
        },
        {
          type: 'autogenerated',
          dirName: 'tools/ide-first/windsurf',
        },
        {
          type: 'category',
          label: '判断与对比',
