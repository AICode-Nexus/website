...
slug: /tools/insights/ai-first-to-harness-engineering-outline
sidebar_label: Harness 工程分享大纲
track: cross-track
kind: insight
...
- [Agent = Model + Harness](/docs/tools/insights/agent-model-plus-harness) — 核心概念文章
- [2026 年 3 月 AI Coding 四个主线变化](/docs/tools/insights/agentic-coding-patterns) — 趋势背景
