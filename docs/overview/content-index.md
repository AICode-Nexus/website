---
title: 内容索引
description: 对比、Playbook 与 Insight 继续保留为内容形态索引，但不再承担站点一级知识骨架。
slug: /content-index
sidebar_label: 内容索引
tags: [ai-coding, content-index, taxonomy]
track: cross-track
kind: hub
content_form: hub
audience: mixed
...
- 如果你缺的是国内外优秀 AI 官网、官方文档、仓库、课程、行业资源和岗位工作入口，去 [AI 资源导航](/docs/ai-directory)。
...
<RelatedReadings
  ...
  items={[
    ...
    },
    {
      ...
      description: '查看国内外优秀 AI 官网、官方文档、开源仓库、课程、行业资源和岗位工作入口。',
    },
    {
      title: '趋势观察',
      href: '/docs/insights',
