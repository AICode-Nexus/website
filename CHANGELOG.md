...
- Reworked `AI 资源导航` from long table-style directory pages into a compact logo grid, with all categories visible on the hub page, hover summaries, and direct outbound clicks.
